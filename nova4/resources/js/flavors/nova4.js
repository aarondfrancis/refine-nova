const novaFlavor = {
  emptyGroup: {
    class:
      'rounded-lg shadow p-2 text-gray-400 bg-white flex items-center justify-between text-sm mb-4 dark:bg-gray-800',

    wrapper: {
      class:
        'border rounded-lg shadow border-50 p-2 text-gray-400 bg-white flex items-center justify-between text-sm mb-4',
    },
