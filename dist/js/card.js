...
Nova.booting(function (Vue, router, store) {
  ...
  Vue.use(_vue_composition_api__WEBPACK_IMPORTED_MODULE_5__["default"]); // Use Nova's default date picker for Refine.
  ...
  Vue.component('custom-or-button', _components_OrButton__WEBPACK_IMPORTED_MODULE_3__["default"]);
  Vue.component('custom-group-divider', _components_GroupDivider__WEBPACK_IMPORTED_MODULE_4__["default"]); // Main card.
    ...
    listbox: {
      ...
      item: {
        ...
        icon: {
          ...
          wrapper: {
            "class": function _class(options) {
              return "absolute pin-t pin-b pin-r flex items-center pr-4 ".concat(!options.isHighlighted ? 'text-blue-600' : 'text-white');
            }
          }
        }
      }
